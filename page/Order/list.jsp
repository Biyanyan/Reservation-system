    ...
    layui.use(['form','table'],function (){
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'username1',  title: '用户名',templet:'<div>{{d.user.username1}}</div>'},
        ...
        form.on('submit(search-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                url:"${basePath}order/query?username="+
                    data.field.username+"&workername="+
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {   // 监听添加操作
                ...
                var index = layer.open({
                    ...
                    shadeClose: false,
                    area: ['50%', '50%'],
                    content: 'order/detail/'+data[0].id,
                    end:function(){
                        table.reload('currentTableId');
                    }
                });
