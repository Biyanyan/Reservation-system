        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="username1" value="${user.username1}" lay-verify="required" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="telephonenumber" value="${user.telephonenumber}" lay-verify="required" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        form.on('submit(save)', function (data) {
            console.log("表格数据:",data.field.id)
            console.log("2:",JSON.stringify(data.field))
            $.ajax({
                url:"${basePath}user/update?id="+
                    data.field.id+"&telephonenumber="+
                    data.field.telephonenumber+"&username1="+
                    data.field.username1,
                type:"POST",
