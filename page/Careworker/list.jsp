                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="workername" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    layui.use(['form','table'],function (){
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'workername',  title: '护工姓名'},
                // {field: 'workerimage', title: '图片'},
                {field: 'workerage',  title: '年龄'},
                {field: 'sex', title: '性别'},
                ...
                {field: 'telephonenumber', title: '联系方式'},
            ]],
            response: {
        ...
        form.on('submit(search-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                url:"${basePath}careworker/query?workername="+
                    data.field.workername+"&sex="+
                    data.field.sex+"&nativeplace="+
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {   // 监听添加操作
                ...
                var index = layer.open({
                    ...
                    shadeClose: false,
                    area: ['50%', '50%'],
                    content: 'careworker/detail/'+data[0].id,
                    end:function(){
                        table.reload('currentTableId');
                    }
                });
                ...
                layer.confirm('真的删除行吗', function (index) {
                    $.ajax({
                        url:"${basePath}careworker/delete",
                        type:"POST",
                        dataType:'json',
                        data:"ids="+arr.join(","),
